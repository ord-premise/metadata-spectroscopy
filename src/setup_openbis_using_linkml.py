...
class OpenBisDatabase:
    ...
    def setup_openbis_database(self):
        ...
        collections_config_filepath = os.path.join(os.sep, "data", "collections_config.json")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("python3 setup_openbis_using_linkml.py [OPENBIS_URL] [OPENBIS_USER] [OPENBIS_PW]")
    ...
    # Load LinkML schema
    yaml_filepath = os.path.join(os.sep, "schema", "spmlink_model.yaml")
